...
export const Github = () => (
  <a href='https://github.com/yuriy-yarosh' target='_blank' rel='noopener noreferrer' aria-label='GitHub' title='GitHub' className='group transition-colors hover:text-slate-800'>
