...
export const ModernControlInAdditiveManufacturingBlogPost = () => {
  return (
    <ContentCard backTitle='Blog' catchBoundary='blog' to='/blog' from='/blog/control-manufacturing'>
      <Heading>Modern Control in Additive</Heading>
      <Paragraph className='font-secondary-title text-xl md:text-2xl'>Modern Control in Additive draft</Paragraph>
    </ContentCard>
  )
}
