...
export const ControlTheoryBlogPost = () => {
  return (
    <ContentCard backTitle='Blog' catchBoundary='blog' to='/blog' from='/blog/modern-control-theory'>
      <Heading>Control Theory</Heading>
      <Paragraph className='mt-4 flex w-auto flex-row justify-center px-4 md:mt-8 md:px-12'>
        Modern control theory Automates Genocide to a much greater extent than people actually realize.
      </Paragraph>
...
export const Route = createFileRoute('/blog/modern-control-theory')({
  component: ControlTheoryBlogPost
})
