...
export const AITelecomBlogPost = () => {
  return (
    <ContentCard backTitle='Blog' catchBoundary='blog' to='/blog' from='/blog/ai-in-telecom'>
      <Heading>AI in Telecom</Heading>
      <Paragraph className='mt-4 flex w-auto flex-row justify-center px-4 md:mt-8 md:px-12'>
        There's a joke that with 4G you can count entire state population, and with 5G you can count every cat inside the apartment.
      </Paragraph>
