...
export const AgentsBlogPost = () => {
  return (
    <ContentCard backTitle='Blog' catchBoundary='blog' to='/blog' from='/blog/self-organizing-control'>
      <Heading>Agentic Control</Heading>
      <Paragraph className='mt-4 flex w-auto flex-row justify-center px-4 md:mt-8 md:px-12'>
        Modern control theory extends to self-organizing systems - self-organizing agentic control and secure communication.
      </Paragraph>
...
export const Route = createFileRoute('/blog/self-organizing-control')({
  component: AgentsBlogPost
})
