...
export const TelecomBlogPost = () => {
  return (
    <ContentCard backTitle='Blog' catchBoundary='blog' to='/blog' from='/blog/telecom'>
      <Heading>Telecom</Heading>
...
export const Route = createFileRoute('/blog/telecom')({
  component: TelecomBlogPost
})
