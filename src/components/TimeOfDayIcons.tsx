...
import type { TimeOfDay as TimeOfDayType } from "#/hooks/useSunDial";

export const TimeOfDayIcons: { [key in TimeOfDayType]: React.ReactNode } = {
	night: (
		<svg
			className="h-5 w-5 transition-opacity group-hover:animate-pulse lg:h-7 lg:w-7 xl:h-8 xl:w-8"
			viewBox="0 0 32 32"
			fill="none"
	...
	dawn: (
		...
		>
			...
			<path
				d="M 5.33 24 Q 16 18.67 26.67 24"
				stroke="currentColor"
				strokeWidth="1.5"
				fill="none"
				strokeLinecap="round"
